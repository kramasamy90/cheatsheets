...
\begin{itemize}
	\item \textbf{Column Space}, $C(A)$: 
    \vspace{-0.75em}
    \begin{itemize}
    \setlength{\itemsep}{-0.5em}
        \item Span of columns of A.\\
        \item $C(A) \subseteq \mathbb{R}^m$.\\
        \item $\dim(C(A))$ = $r$.
    \end{itemize}

	\item \textbf{Row Space}, $R(A)$: 
    \begin{itemize}
    \vspace{-0.75em}
    \setlength{\itemsep}{-0.5em}
        \item Span of rows of A.\\
        \item $R(A) \subseteq \mathbb{R}^n.$\\ 
        \item $\dim(R(A))$ = $r$.
    \end{itemize}

	\item \textbf{Null Space}, $N(A)$: 
    \vspace{-0.75em}
    \begin{itemize}
    \setlength{\itemsep}{-0.5em}
        \item $\{x \mid Ax = 0, x \in \mathbb{R}^n\}$ 
        \item $\dim(N(A))$ = $n-r$.
    \end{itemize}

	\item \textbf{Left Null Space}, $N(A^T)$: 
    \vspace{-0.75em}
    \begin{itemize}
    \setlength{\itemsep}{-0.5em}
        \item $\{x \mid A^Tx = 0, x \in \mathbb{R}^m\}$ 
        \item $\dim(N(A^T))$ = $m-r$.
    \end{itemize}
\end{itemize}
...
$x_{B_1} \rightarrow$ w.r.t. the basis $B_1$.\\
$x_{B_2} \rightarrow$ w.r.t. the basis $B_2$.\\

$x_{B_1} = {B_1}^{-1} x$, or, $x = B_1x_{B_1}$\\
$x_{B_2} = {B_2}^{-1}B_1x_{B_1}$\\
