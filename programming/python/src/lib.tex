...
\texttt{File}                       & \texttt{h5py} File object.\\
                                    & Like a regular file object.\\
                                    & \texttt{f = h5py.File("foo.h5")}.\\
\texttt{h5py.\_hl.files.File}       & File object type, i.e. \texttt{type(f)}.\\
                                    & Behaves like a dictionary.\\
\texttt{h5py.\_hl.group.Group}      & Behaves like a dictionary.\\
                                    & File object inherits from \texttt{Group}
                                        \textcolor{red}{Verify}.\\
\texttt{h5py.\_hl.dataset.Dataset}  & Behaves like an np array.\\
\texttt{h5py.\_hl.attrs.AttribureManager} & Behaves like a dict.\\
\end{tabularx}
