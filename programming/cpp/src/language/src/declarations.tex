...
\texttt{<delc-type-specifier> <declarator>}
...
Eg: \texttt{int *const p;}\\
Here \texttt{const} is part of the declarator.
...
\begin{tabularx}{\linewidth}{lX}
    ...
    \hline
    auto                   & Type deduction based on initializer.\\
                           & Eg: \texttt{auto x = 10; // x is int}\\
    decltype               & Deduces type of an expression.\\
